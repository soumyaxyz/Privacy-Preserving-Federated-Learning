...
def make_private(differential_privacy, model, optimizer, train_loader):
    if  differential_privacy:
        ...
        model, optimizer, train_loader = privacy_engine.make_private(module=model, optimizer=optimizer, data_loader=train_loader, noise_multiplier=0.09, max_grad_norm=1.0)
